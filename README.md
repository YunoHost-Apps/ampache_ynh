...
The user panel button was disabled because it hide an essential part of the ampache user interface.

Also, the SSO authentication not fully working from user panel, we have to work about this.
In fact, it's can disrupt external Ampache clients like Subsonic.
